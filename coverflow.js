...
coverflowimages({
	coverid: 'coverflow1',
	images: [
						['./images/1.jpg', './images/1.jpg', 'Chilling with nature. Nature is the foundation of life, a place to seek peace, a place to spend time away from the busy everyday routine.'],
						['./images/2.jpg', './images/2.jpg', 'Sun kissed.'],
						['./images/3.jpg', './images/3.jpg'],
						['./images/7.jpg', './images/7.jpg'],
						['./images/9.jpg', './images/9.jpg', 'Through a different window, there is always a view to enjoy.'],
						['./images/12.jpg', './images/12.jpg', 'Through a different window, there is always a view to enjoy.'],
						['./images/6.jpg', './images/6.jpg', 'Through a different window, there is always a view to enjoy.'],
						['./images/10.jpg', './images/10.jpg', 'A day with family is always a day well spent.'] // <-- no comma after last image
